...
#ifndef _TextLineExtractorGreySeam_H 
#define _TextLineExtractorGreySeam_H 
...
class MANUSCRIPT_API TextLineExtractorGreySeam : public TextLineExtractor {
...
public:
	//Constructor
	TextLineExtractorGreySeam(int rows);
	~TextLineExtractorGreySeam();
