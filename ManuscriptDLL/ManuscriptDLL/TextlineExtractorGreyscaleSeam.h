#ifndef _TextLineExtractorGreyscaleSeam_H 
#define _TextLineExtractorGreyscaleSeam_H 
...
class MANUSCRIPT_API TextLineExtractorGreyscaleSeam : public TextLineExtractor {
...
public:
	//Constructor
	TextLineExtractorGreyscaleSeam(int rows);
	~TextLineExtractorGreyscaleSeam();
